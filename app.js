...
const app = {
    ...
    checkChannelJoin() {
        if (!this.state.user.isJoined) {
            const overlay = document.getElementById('join-channel-overlay');
            const link = document.getElementById('tg-channel-link');
            link.href = this.state.settings.tgChannel;
